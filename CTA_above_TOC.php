...
<main id="primary" class="">
	<?php get_template_part('template-parts/heros/desktop_and_mobile_hero_full_width_no_blur'); ?>
	<div class="page_grid">
      ...
      <!-- CTA Under -->      
  <section class="cta_padding"> <?php if (get_field('page_subheadline_paragraph')) : ?>
