...
<main id="primary" class="front_page">
	...
	<!-- Features -->
	<?php get_template_part('template-parts/content/shortcodes/sbh_features_section'); ?>
	...
	<section>
		<div class="">
			<div class="badge_container flex flex-wrap">
				<div class="badge_image">
					<a title="Verify LegitScript Approval" class="legit_script_wrapper" href="https://legitscript.com" rel="noopener noreferrer">
	...
	<section>
		<div class="treatment_resources_container wrapper">
			<div class="treatment_resources_container_headline">
				<?php echo get_field('addiction_treatment_resources_link'); ?>
					<div class="icon_container"><img loading="lazy" src="<?php echo get_field('addiction_treatment_headline_icon')['url'] ?>"></div>

					<h2 class="text-center"><?php echo get_field('addiction_treatment_resources_headline') ?></h2>
