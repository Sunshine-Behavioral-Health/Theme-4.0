...
function directory_cta()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/directory_cta');
	return ob_get_clean();
}

add_shortcode('directory_cta', 'directory_cta');
...
function sbh_features_section()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/sbh_features_section');
	return ob_get_clean();
}

add_shortcode('sbh_features_section', 'sbh_features_section');
...
function a_b_insurance_form()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/a_b_insurance_form');
	return ob_get_clean();
}

add_shortcode('a_b_insurance_form', 'a_b_insurance_form');

function a_b_contact_form()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/a_b_contact_form');
	return ob_get_clean();
}

add_shortcode('a_b_contact_form', 'a_b_contact_form');

function a_b_buttons()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/a_b_buttons');
	return ob_get_clean();
}
...
function single_button()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/single_button');
	return ob_get_clean();
}

add_shortcode('single_button', 'single_button');
function two_buttons()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/two_buttons');
	return ob_get_clean();
}

add_shortcode('two_buttons', 'two_buttons');
function contact_form_without_subheadline()
{
	ob_start();
	get_template_part('template-parts/content/shortcodes/contact_form_without_subheadline');
	return ob_get_clean();
}

add_shortcode('contact_form_without_subheadline', 'contact_form_without_subheadline');
